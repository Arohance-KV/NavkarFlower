        ...
        <div className="flex items-center justify-between h-20">
         ...
         <NavLink to="/" className="flex items-center">
          ...
          <div className="flex items-center gap-6">
            <button className="text-amber-900 hover:text-amber-700 transition-colors">
              <Search size={24} />
            </button>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 border-t-2 font-slab border-amber-900">
            ...
            <NavLink
              to="/login"
              onClick={() => setIsOpen(false)}
              className="block mx-4 mt-3 text-center border border-amber-900
                         text-amber-900 py-2 rounded-lg font-slab
                         hover:bg-amber-900 hover:text-white transition"
            >
              Login
            </NavLink>
