...
const ContactUs = () => {
  return (
    <section
      className="relative py-10 px-4 min-h-screen"
      style={{
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="max-w-2xl mx-auto text-amber-800 text-lg font-slab">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="border-2 border-[#C58C8C] p-2 rounded-4xl [corner-shape:scoop]">
            <div className="bg-transparent font-slab rounded-4xl [corner-shape:scoop] shadow-lg p-8 min-h-125 flex flex-col">
              ...
              <div className="flex-1 flex flex-col justify-between">
                <div className="flex items-start gap-4 py-4">
                  <FiPhone className="text-amber-700 mt-1" size={24} />
                  <div>
                ...
                <div className="flex items-start gap-4 py-4">
                  <FiMail className="text-amber-700 mt-1" size={24} />
                  <div>
                ...
                <div className="flex items-start gap-4 py-4">
                  <FiMapPin className="text-amber-700 mt-1" size={24} />
                  <div>
                ...
                <div className="flex items-start gap-4 py-4">
                  <FiClock className="text-amber-700 mt-1" size={24} />
                  <div>
        ...
        <div className="text-center mt-16 text-gray-700">
          <p className="text-2xl font-script text-amber-900">
